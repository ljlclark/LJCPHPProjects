...
The GenDoc app generates HTML documentation from PHP source file XML comments.
...
GenCodeDoc - Calls DocDataLib and GenDataLib for each PHP file to generate the
             CodeDoc HTML files.
             The program entry file: GenCodeDocFiles.php
             The example cmd file: GenCodeDocFiles.cmd
