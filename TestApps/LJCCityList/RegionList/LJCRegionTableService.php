<?php
  ...
  //    CreateResponse(), 
  /// <summary>Web Service to Create an HTML table from Region data.
  class LJCRegionTableService
  {
    // ---------------
    // Entry Methods
    ...
    {
      $this->ClassName = "LJCRegionTableService";
      $methodName = "Request()";
    ...
    private function HTMLTableBuilder(?array $propertyNames)
    {
      ...
      LJC::RemoveString($propertyNames, Region::PropertyRegionID);
    ...
    private function ResultKeyArray($result, $keyNames)
    {
      ...
      $dataManager = $this->RegionManager->DataManager;
