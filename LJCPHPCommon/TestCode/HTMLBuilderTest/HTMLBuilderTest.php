<?php
  ...
  class TestHTMLBuilder
  {
    ...
    private static function AddChildIndent()
    {
      ...
      $compare = "<body>";
      LJC::DebugCompare("AddChildIndent()", $result, $compare);
    }
    ...
    private static function AddIndent()
    {
      ...
      $compare = $b->ToString();
      LJC::DebugCompare("AddIndent()", $result, $compare);
    }
    ...
    private static function EndsWithNewLine()
    {
      ...
      $b->AddText("False");
      $compare = $b->ToString();
      LJC::DebugCompare("EndsWithNewLine()", $result, $compare);
      return $retValue;
    }
    ...
    private static function HasText()
    {
      ...
      $compare = "False";
      LJC::DebugCompare("HasText()", $result, $compare);
    }
    ...
    private static function StartWithNewLine()
    {
      ...
      $b->AddText("False");
      $compare = $b->ToString();
      LJC::DebugCompare("StartWithNewLine()", $result, $compare);
      return $retValue;
    }
    ...
    private static function AddLine()
    {
      ...
      $b->AddText(":");
      $compare = $b->ToString();
      LJC::DebugCompare("AddLine()", $result, $compare);
    }
    ...
    private static function AddText()
    {
      ...
      LJC::DebugCompare("AddText()", $result, $compare);
    }
    ...
    private static function Line()
    {
      ...
      $compare = $b->ToString();
      LJC::DebugCompare("Line()", $result, $compare);
    }
    ...
    private static function Text()
    {
      ...
      $b->AddText("  This is an indented line.");
      $compare = $b->ToString();
      LJC::DebugCompare("Text()", $result, $compare);
    }
    ...
    private static function GetAttribs()
    {
      ...
      $b->AddText("</div>");
      $compare = $b->ToString();
      LJC::DebugCompare("GetAttribs()", $result, $compare);
    }
    ...
    private static function GetIndented()
    {
      ...
      $compare = $b->ToString();
      LJC::DebugCompare("GetIndented()", $result, $compare);
    }
    ...
    private static function GetIndentString()
    {
      ...
      $compare = "  :";
      LJC::DebugCompare("GetIndentString()", $result, $compare);
    }
    ...
    private static function GetLine()
    {
      ...
      $b->AddText("  :");
      $compare = $b->ToString();
      LJC::DebugCompare("GetLine()", $result, $compare);
    }
    ...
    private static function GetText()
    {
      ...
      $b->AddText("  This is an indented line.");
      $compare = $b->ToString();
      LJC::DebugCompare("GetText()", $result, $compare);
    }
    ...
    private static function GetWrapped()
    {
      ...
      $compare = $b->ToString();
      LJC::DebugCompare("GetWrapped()", $result, $compare);
    }
    ...
    private static function Begin()
    {
      ...
      $b->AddText("<body>");
      $compare = $b->ToString();
      LJC::DebugCompare("Begin()", $result, $compare);
    }
    ...
    private static function Create()
    {
      ...
      $b->AddText("<p></p>");
      $compare = $b->ToString();
      LJC::DebugCompare("Create()", $result, $compare);
    }
    ...
    private static function End()
    {
      ...
      $b->AddText("</p>");
      $compare = $b->ToString();
      LJC::DebugCompare("End()", $result, $compare);
    }
    ...
    private static function GetBegin()
    {
      ...
      $b->AddText("<body>");
      $compare = $b->ToString();
      LJC::DebugCompare("GetBegin()", $result, $compare);
    }
    ...
    private static function GetCreate()
    {
      ...
      $b->AddText("<p></p>");
      $compare = $b->ToString();
      LJC::DebugCompare("GetCreate()", $result, $compare);
    }
    ...
    private static function GetEnd()
    {
      ...
      $b->AddText("</p>");
      $compare = $b->ToString();
      LJC::DebugCompare("GetEnd()", $result, $compare);
    }
  }
?>
